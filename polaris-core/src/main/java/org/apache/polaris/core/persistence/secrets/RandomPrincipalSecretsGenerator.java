...
public class RandomPrincipalSecretsGenerator extends PrincipalSecretsGenerator {

  public RandomPrincipalSecretsGenerator(@Nullable String realmName) {
    super(realmName);
  }
  ...
  public PolarisPrincipalSecrets produceSecrets(@NotNull String principalName, long principalId) {
    return new PolarisPrincipalSecrets(principalId);
  }
